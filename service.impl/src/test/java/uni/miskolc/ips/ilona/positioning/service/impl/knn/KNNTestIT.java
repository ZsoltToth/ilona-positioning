...
public class KNNTestIT {
    ...
    public void test() throws IOException, InvalidMeasurementException {
        ...
        KNNPositioning knnPositioning = new KNNSimplePositioning(new MeasurementDistanceCalculatorImpl(new VectorIntersectionWiFiRSSIDistance(), 0.6, 0.4, 0.1, 0.5, 0.0), measurementGateway, 3);
        Position result = knnPositioning.determinePosition(measurementFromJSON());
        Assert.assertNotNull(result);


    }

    private Measurement measurementFromJSON() throws JsonParseException, JsonMappingException, IOException {

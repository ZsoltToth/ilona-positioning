...
public abstract class KNNPositioning implements PositioningService {
    ...
    /**
     * @param distanceCalculator The distance function used in k-NN.
     * @param measurementGateway The measurementGateway provide access to the measurements in
     *                           the database
     * @param k                  is the k parameter of the k Nearest Neighbour algorithm.
     */
    ...
    /**
     * @param measurement The measurement we want to know the Position.
    ...
    public final Position determinePosition(final Measurement measurement) throws IllegalArgumentException, InvalidMeasurementException {
        ...
        try {
            measurements = new ArrayList<Measurement>(MeasurementDTOConverter.convertToMeasurements(measurementGateway.listMeasurements()));
        } catch (Exception e) {
    ...
    /**
     * @param measurements The measurements from the database
     * @param measurement  The measurement we want to determine neighbours
     ...
     *
     * @param neighbours The list of the neighbours
